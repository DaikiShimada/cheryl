...
if __name__ == '__main__':
    token = 'xoxp-15454210802-15668886017-15670254304-73dcd5333a'
    cheryl_api = CherylAPI(token=token, configfile='./cheryl.json')
    cheryl_api.post_direct_message_by("kantoku", "test", ["cheryl_status.json"])
